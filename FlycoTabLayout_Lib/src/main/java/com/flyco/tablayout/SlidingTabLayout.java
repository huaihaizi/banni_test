...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            ImageView image_logo = (ImageView) v.findViewById(com.flyco.tablayout.R.id.image_logo);
            if( i == 0 ){
                image_logo.setVisibility(VISIBLE);
            }else{
                image_logo.setVisibility(INVISIBLE);
            }
        }
    }
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(isSelect ? 18 : 15);
                if(isSelect){
                    tab_title.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));//设置选中加粗
                }else{
