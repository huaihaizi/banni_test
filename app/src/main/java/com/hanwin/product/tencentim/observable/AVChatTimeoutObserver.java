...
public class AVChatTimeoutObserver {
    ...
    private final int OUTGOING_TIME_OUT = 30 * 1000;
    private final int INCOMING_TIME_OUT = 30 * 1000;
    ...
    private AVChatTimeoutObserver() {
        uiHandler = new Handler(BaseApplication.getInstance().getMainLooper());
    }
    ...
    public void observeTimeoutNotification(Observer<Integer> observer, boolean register, boolean isIncoming) {
        Log.e(TAG, "observeTimeoutNotification->" + observer + "#" + register);
