package com.hanwin.product.viewutils.pulltorefresh;
...
import com.hanwin.product.viewutils.pulltorefresh.pullableview.Pullable;
		...
		if(refreshStateImageView != null && refreshStateTextView != null){
			switch (refreshResult) {
				...
				default:
					...
					refreshStateImageView.setBackgroundResource(R.drawable.refresh_fail);
					break;
			}
		}
		...
		if(loadStateImageView != null && loadStateTextView != null){
			switch (refreshResult) {
				...
				case DONE:
					...
					loadStateTextView.setText(R.string.load_not_data);
					loadStateImageView.setBackgroundResource(R.drawable.refresh_success);
					break;
				case FAIL:
				default:
