package com.hanwin.product.utils.ImageCompressUtils;
...
import static com.hanwin.product.utils.ImageCompressUtils.Preconditions.checkNotNull;

/**
 * Created by zhaopf on 2017/11/30.
 * 选择什么档位看需要--一般情况都推荐选THIRD_GEAR档
 * 1.这3种档次都进行了质量压缩，要上传到服务器的话尽量选3(清晰度可以，大小可以)
...
public class Luban {
    ...
    // for single file
    public rx.Subscription launch(final OnCompressListener listener) {
    ...
    // for multi file
    public rx.Subscription launch(final OnMultiCompressListener listener) {
        checkNotNull(listener, "the listener cannot be null !");
    ...
    private String getCacheFilePath() {
        ...
        return Environment.getExternalStorageDirectory().getPath() + "/bintutuImgage"+"/smallCrop/"+ name;
    }
